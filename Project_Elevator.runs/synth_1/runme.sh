...
HD_PWD='C:/Users/lupi1/Documents/Vivado/Project_Elevator/Project_Elevator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_Elevator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Project_Elevator.tcl
