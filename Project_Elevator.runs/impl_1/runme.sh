...
HD_PWD='C:/Users/lupi1/Documents/Vivado/Project_Elevator/Project_Elevator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Project_Elevator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Project_Elevator.tcl -notrace
